...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react_hot_loader__ = __webpack_require__(28);
...
throw new Error("Module build failed: SyntaxError: C:\\Users\\Użytkownik\\Desktop\\projekty\\zadanie_18\\client\\App.js: Unexpected token (34:7)\n\n  32 | \n  33 | \thandleMessageSubmit(message) {\n> 34 | \t\tconst.messages = [message, ...this.state.messages];\n     | \t\t     ^\n  35 | \t\tthis.setState({messages});\n  36 | \t\tsocket.emit('message', message);\n  37 | \t}\n");
